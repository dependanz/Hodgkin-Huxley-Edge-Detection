...
%             k1h = (h_inf(V(x_c_i, y_c_i,j)) - h(x_c_i, y_c_i, j))/tau_h(V(x_c_i, y_c_i,j));
            k1n = alpha_n(V(x_c_i, y_c_i,j)) * (1 - n(x_c_i, y_c_i,j)) - beta_n(V(x_c_i, y_c_i,j)) * n(x_c_i, y_c_i,j);
            k1m = alpha_m(V(x_c_i, y_c_i,j)) * (1 - m(x_c_i, y_c_i,j)) - beta_m(V(x_c_i, y_c_i,j)) * m(x_c_i, y_c_i,j);
            k1h = alpha_h(V(x_c_i, y_c_i,j)) * (1 - h(x_c_i, y_c_i,j)) - beta_h(V(x_c_i, y_c_i,j)) * h(x_c_i, y_c_i,j);
...
%             k2h = (h_inf(a2V1) - a2h)/tau_h(a2V1);
            k2n = alpha_n(a2V1) * (1 - a2n) - beta_n(a2V1) * a2n;
            k2m = alpha_m(a2V1) * (1 - a2m) - beta_m(a2V1) * a2m;
            k2h = alpha_h(a2V1) * (1 - a2h) - beta_h(a2V1) * a2h;
